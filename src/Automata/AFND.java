 ...
 * Los estados son cadenas de caracteres (String)
 * Los símbolos de entrada son caracteres (Character) así como la palabra vacía lambda (L)
 * No resulta necesario implementar un conjunto de estados del autómata para su funcionamiento
 * Tan solo necesita un conjunto de símbolos de entrada y de transiciones de estados, así como un estado inicial y un conjunto de estados finales.
...
public class AFND implements Cloneable, Proceso{
    ...
    /**
     * Establece el conjunto de lambda-transiciones pasado por parámetro en el autómata 
     * @param transicionesL
     */
    ...
    /**
     * Devuelve el conjunto de estados destino a los que evoluciona el autómata dado un conjunto de estados origen
    ...
    /**
     * Obtiene el estado destino al que evoluciona el autómata con una lambda-t desde el estado origen pasado por parámetro
     * @param estado Estado origen
     * @return Estado destino
     */
    ...
    /**
     * Devuelve verdadero si el estado pasado por parámetro es un estado final o de aceptación
     * @param estado
     * @return
     */
    ...
    /**
     * Devuelve verdadero si alguno de los estados pasados por parámetro es un estado final o de aceptación
    ...
    /**
     * Devuelve la lambda-clausura del estado pasado por parámetro
     * Conjunto de estados destino a los que evoluciona el autómata con lambda-transiciones
    ...
    /**
     * Devuelve la lambda-clausura de un conjunto de estados pasados por parámetro
     * Conjunto de estados destino a los que evoluciona el autómata con lambda-transiciones
    ...
    /**
     * Simula el funcionamiento del autómata
     * Recorre la cadena de entrada y evoluciona el estado actual según lo definido en las transiciones del autómata
     * Si el estado al que evolucion al leer el último símbolo de entrada de la cadena es un estado final o de aceptación, la cadena es reconocida
     * @param cadena Símbolos de entrada a reconocer por el autómata
     * @return verdadero si la cadena es reconocida por el autómata (pertenece a su lenguaje formado)
     */
    ...
    /**
     * Devuelve una copia del autómata
     * Se crean nuevos objetos, no se clonan las referencias
     * @return
     */
    @Override
    public Object clone()
